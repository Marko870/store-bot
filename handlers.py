...
async def cb_approve_order(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if q.message.caption is not None:
            ...
            await q.edit_message_text(new_caption,
                parse_mode="Markdown", reply_markup=new_kb)
    except Exception:
